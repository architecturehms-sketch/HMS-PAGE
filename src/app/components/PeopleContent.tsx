...
export function PeopleContent({ team }: PeopleContentProps) {
  ...
  const cardHeight = isMobile ? 185 : 220;
  ...
  return (
    ...
    >
      ...
      <div 
        className="w-full pt-4 pb-1 md:py-6 px-4 sm:px-8 flex flex-col items-center justify-start text-[#f4f4f0] z-20 relative bg-[#111] shrink-0"
      >
            ...
            <AnimatePresence initial={false}>
              {selectedMember && (
                ...
                >
                  ...
                  <div className="w-full max-w-6xl flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-10 px-4 pb-10 md:pb-40">
                    {/* Left: Original Image */}
      ...
      >
        <div 
          className="absolute top-[25%] md:top-[25%] left-1/2 w-0 h-0 flex items-center justify-center" 
          style={{ 
        ...
        <div className="absolute bottom-8 md:bottom-6 left-1/2 -translate-x-1/2 bg-[#1a1a1a]/80 backdrop-blur-md px-6 py-3 rounded-full font-mono text-[10px] text-[#f4f4f0] tracking-[0.2em] uppercase z-50 pointer-events-none shadow-lg border border-white/10 whitespace-nowrap">
